...
var mongooseFactory = o
  ...
  .persist(function(instance, done) {
      instance.save(done);
    })
  .defaultOptions({
      foodhub: 'sfbay'
...
var orderFactory = mongooseFactory
  ...
  .defaults({
    ...
    'customer.phone': faker.phone,
    'customer.previousOrders': 5,
    fulfillmentId: o.sync(function(factory) {
    ...
    gift: false,
    deliveryInstructions: 'Leave it behind the front gate',
    leaveDelivery: true,
    active: true,
    number: 1,
    status: 'undelivered'
